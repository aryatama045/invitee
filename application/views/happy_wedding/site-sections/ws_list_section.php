				 ...
				 if(isset($ws_list) && !empty($ws_list)) {
					...
					<div class="grid <?php echo $blog_col_class; ?>">
						<div class="entry-media sc_fam">
							<a href="<?php echo base_url().$row->site_name.'/'.$row->id;?>" target="_blank" 
							title="<?php echo $row->wedding_title; ?>">
							<?php 
						...
						<div class="details">
							<h3 class="text-center "><a href="<?php echo base_url().$row->site_name.'/'.$row->id;?>" target="_blank" 
