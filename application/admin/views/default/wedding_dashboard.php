					...
					<div class="box-body">
						...
						<div class="step1 tab-block" style="display:none;">
							<div class="row">
								...
								<div class="col-md-6">
									<div class="form-group">
										<label for="wedding_side" >Wedding Side</label>
										<select  class="form-control select2_elem" id="wedding_side" name="wedding_side"/>
											<option value="groom" <?php if(isset($row->wedding_side) && $row->wedding_side == 'groom') echo 'selected="selected"'; ?>>Groom Side</option>
											<option value="bride" <?php if(isset($row->wedding_side) && $row->wedding_side == 'bride') echo 'selected="selected"'; ?>>Bride Side</option>
										</select> 
									</div>
								</div>
						...
						<div class="step2 tab-block" style="display:none;">
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										<label for="groom_name" style="display: block;">Groom Name</label>
									...
									<div class="form-group">
										...
										data-target="groom_tag_line_container" name="groom_tag_line" value="<?php if(isset($row)) echo $row->groom_tag_line; ?>"/>
									</div>
									
									<div class="form-group">
										<label for="groom_signature" style="display: block;">Signature</label>
										<input type="text" id="groom_signature" class="form-control" name="groom_signature" value="<?php if(isset($row)) echo $row->groom_signature; ?>"/>
									</div>
									
									<div class="form-group">
										<label for="groom_short_description" style="display: block;">About Groom</label>
						...
						<div class="step3 tab-block" style="display:none;">
							<div class="row">
								...
								<div class="col-md-6">
									<div class="form-group">
										<label for="bride_name" style="display: block;">Bride Name</label>
										<input type="text" id="bride_name" class="form-control on-change-cls" 
										data-target="bride_name_container" name="bride_name" value="<?php if(isset($row)) echo $row->bride_name; ?>"/>
									</div>
									...
									<div class="form-group">
										...
										data-target="bride_tag_line_container" name="bride_tag_line" value="<?php if(isset($row)) echo $row->bride_tag_line; ?>"/>
									</div>
									...
									<div class="form-group">
										<label for="bride_short_description" style="display: block;">About Bride</label>
