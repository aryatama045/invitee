...
<section class="content-header">
	<h1  class="page-title"><i class="fa fa-plus"></i> <?php echo mlx_get_lang('Add New Slider'); ?></h1>
	...
	<section class="content">
		<?php $attributes = array('name' => 'add_form_post','class' => 'form'); echo form_open_multipart('slider/add_new',$attributes); ?>
							...
							<div class="col-md-12">
								...
								<label for="exampleInputFile" style="display: block;">Photo <span class="required">*</span></label>
									<div class="pl_image_container">
										<label class="custom-file-upload" data-element_id="" data-type="slider" id="pl_file_uploader_1">
